...
#generate random string of 7 small letters digits
randPass = ''.join(random.choices(string.ascii_uppercase + string.digits + string.punctuation, k = 7)) #generate random string less than 5 digits
...
if driver.find_element_by_xpath('/html/body/div[2]/div[1]/div[1]/div/div/div[1]/div/div[1]/img'):
    driver.save_screenshot('failed_password_of_small_letters.png')

# write in execution report, that this test case failed
f = open('LoginPasswordSmallLetters.txt' , 'w')
f.write('LoginPasswordSmallLetters' +'\n')
...
##################################Test case tests firstname equal to last name#####################
driver.close() #close window
...
##################################Test case tests password more than 32 characters#####################
driver.close() #close window
...
LastName = driver.find_element_by_name('lastname') #get last name element by name
LastName.send_keys(randLN) #enter same string of first name in last name
LastName.get_attribute('value')
...
password = driver.find_element_by_name('password') #get password element by name
randPassMoreThan32 = ''.join(random.choices(string.ascii_uppercase + string.digits + string.punctuation, k = 33)) #generate random string less than 5 digits
password.send_keys(randPassMoreThan32) #enter password in text field
passvalue = password.get_attribute('value')

confirmpassword = driver.find_element_by_name('confirmpassword')
confirmpassword.send_keys(randPassMoreThan32) #enter the same password entered before in password text field
...
#if the image in the page appears after submit successfully appears, take screenshot
if driver.find_element_by_xpath('/html/body/div[2]/div[1]/div[1]/div/div/div[1]/div/div[1]/img'):
    driver.save_screenshot('failed_password_more_than_32.png')

# write in execution report, that this test case failed
f = open('LoginPasswordMoreThan32.txt' , 'w')
f.write('LoginPasswordMoreThan32' +'\n')
f.write('Failed Test Case.')




##################################Test case tests first name and last name are small letters#####################
driver.close() #close window
...
FirstName = driver.find_element_by_name('firstname')
randFN = ''.join(random.choices(string.ascii_lowercase + string.digits, k = 7)) #genereate random string of lower letters
FirstName.send_keys(randFN) #enter the random string in first name
FirstName.get_attribute('value')

LastName = driver.find_element_by_name('lastname') #get last name element by name
randLN = ''.join(random.choices(string.ascii_lowercase + string.digits, k = 7)) #genereate random string of lower letters
LastName.send_keys(randLN) #enter same string of first name in last name
LastName.get_attribute('value')
...
#if the image in the page appears after submit successfully appears, take screenshot
if driver.find_element_by_xpath('/html/body/div[2]/div[1]/div[1]/div/div/div[1]/div/div[1]/img'):
    driver.save_screenshot('failed_small_letters_in_first_and_last_name.png')

# write in execution report, that this test case failed
f = open('LoginSmallCharacters.txt' , 'w')
f.write('LoginSmallCharacters' +'\n')
f.write('Failed Test Case.')



###########Test Case tests password with less than 6 characters#########################
driver = webdriver.Chrome('chromedriver.exe')
driver.get('https://www.phptravels.net/register')
driver.maximize_window()
...
password = driver.find_element_by_name('password') #get password element by name
randPassLessThan6 = ''.join(random.choices(string.ascii_uppercase + string.digits + string.punctuation, k = 5)) #generate random string less than 5 digits
password.send_keys(randPassLessThan6) #enter password in text field
passvalue = password.get_attribute('value')

confirmpassword = driver.find_element_by_name('confirmpassword')
confirmpassword.send_keys(randPassLessThan6) #enter the same password entered before in password text field
